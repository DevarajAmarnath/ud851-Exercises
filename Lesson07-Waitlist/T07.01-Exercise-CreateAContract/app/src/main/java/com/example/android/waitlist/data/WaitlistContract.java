...
public class WaitlistContract {
    ...
    public static final class WaitlistEntry implements  BaseColumns {
        ...
        // TABLE_NAME -> waitlist;
        public static final String TABLE_NMAE = "waitlist";
        // COLUMN_GUEST_NAME -> guestName
        public static final String COLUMN_GUEST_NAME = "guestName";
        // COLUMN_PARTY_SIZE -> partySize
        public static final String COLUMN_PARTY_SIZE = "guestName";
        // COLUMN_TIMESTAMP -> timestamp
        public static final String COLUMN_TIMESTAMP = "guestName";
