...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        addGuest(mNewGuestNameEditText.getText().toString(), party_size);
    ...
    private void addGuest(String guestName, int partyCount){
        ContentValues cv = new ContentValues();
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, guestName);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE, partyCount);
