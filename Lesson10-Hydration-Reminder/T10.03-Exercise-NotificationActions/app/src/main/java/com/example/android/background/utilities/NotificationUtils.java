...
public class NotificationUtils {
    ...
    public static void clearAllNotificaitons(Context context){
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        Intent ignoreRemainderIntent = new Intent(context, WaterReminderIntentService.class);
        ignoreRemainderIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
